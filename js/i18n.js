const translations = {
  pt: {
    ...
    panelHome: "Ola! Meu nome e Davi Manieri, sou Tecnico de Desenvolvimento de Sistemas e tenho formacao concluida em Python, alem de habilidades com outras linguagens de programacao, logica e exatas, juntamente com a dedicacao e o empenho em cada atividade que me e requisitada!\nEstou a disposicao para realizar trabalhos que estejam inseridos dentro do meu contexto de formacao academica!",
  ...
  en: {
    ...
    menuContact: "Contact",
    panelHome: "Hello! My name is Davi Manieri. I am a Systems Development Technician with completed training in Python, plus skills in other programming languages, logic, and math, along with dedication and commitment in every task I am asked to do.\nI am available for work aligned with my academic background.",
